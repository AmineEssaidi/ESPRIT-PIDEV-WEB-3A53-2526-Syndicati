 ...
 */
final class Version20260219231359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE maintenance ADD etat_app VARCHAR(20) DEFAULT NULL, ADD etat_plomberie VARCHAR(20) DEFAULT NULL, ADD etat_electricite VARCHAR(20) DEFAULT NULL, ADD etat_chauffage VARCHAR(20) DEFAULT NULL, ADD date_derniere_maintenance DATE DEFAULT NULL, ADD description_maint VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE maintenance DROP etat_app, DROP etat_plomberie, DROP etat_electricite, DROP etat_chauffage, DROP date_derniere_maintenance, DROP description_maint');
