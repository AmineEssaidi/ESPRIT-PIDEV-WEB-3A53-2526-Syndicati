 ...
 */
final class Version20260211165134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appartement ADD prix_vente DOUBLE PRECISION DEFAULT NULL, CHANGE type_a type_a ENUM(\'STUDIO\', \'S+1\', \'S+2\', \'S+3\', \'S+4\', \'S+5\')');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appartement DROP prix_vente, CHANGE type_a type_a VARCHAR(255) DEFAULT NULL');
